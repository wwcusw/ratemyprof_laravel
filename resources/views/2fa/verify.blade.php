<x-guest-layout>
    <h2 class="text-2xl font-bold mb-8 text-center text-gray-800 dark:text-white">Two-Factor Authentication</h2>
    <form method="POST" action="{{ route('2fa.verify') }}" class="w-full space-y-6">
        @csrf
        <div>
